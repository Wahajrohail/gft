...
(function () {
  ...
  $(document).ready(function () {
    ...
    var module = $(
      '.home-section, .module, .module-small, .side-image'
    );
    ...
    $('.section-scroll').bind('click', function (e) {
      ...
      $('html, body')
        ...
        .animate(
          {
            scrollTop:
              $(anchor.attr('href')).offset().top - 50,
          },
          1000
        );
      e.preventDefault();
    ...
    $('#reservationForm').submit(function (e) {
      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          $(
            '#reservationForm textarea[name=people]'
          ).val('');
          $(
            '#reservationForm textarea[name=email]'
          ).val('');
        },
        error: function (data) {
          alert('Error occurd! Please try again');
    ...
    var mkr = new google.maps.LatLng(
      31.4573521,
      -106.3299791
    );
    var cntr = mobileTest
